...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (!testuser.isPresent()) {
            ...
            Product newProd = new Product("CAMERA", "Heavily Used", LocalDateTime.now().toString(), "ELECTRONICS",
                    "Film Type Camera");
            newProd.setImageUrl(
        ...
        if (!testadmin.isPresent()) {
            ...
            userInfos.save(userInfo);
            Product newProd = new Product("LAPTOP", "Brand New", LocalDateTime.now().toString(), "ELECTRONICS", "Works");
            newProd.setImageUrl(
            ...
            newProd.setUser(user);
            System.out.println("[Add product]:" + products.save(newProd));
            newProd = new Product("Micro-USB Wire", "Heavily Used", LocalDateTime.now().toString(), "ELECTRONICS",
        ...
        if (!testuser2.isPresent()) {
            ...
            Product newProd = new Product("3-FAN TOWER", "Lightly Used", LocalDateTime.now().toString(), "ELECTRONICS",
                    "Works fine");
            newProd.setImageUrl(
            ...
            newProd.setUser(user);
            System.out.println("[Add product]:" + products.save(newProd));
            newProd = new Product("COCACOLA GLASS", "Lightly Used", LocalDateTime.now().toString(), "OTHERS",
