...
public class NotificationController {
    ...
    public List<NotificationResponse> getNotificationByUsername(@PathVariable String username) {
        ...
        for (Notification notif : notiflist) {
            ...
            new NotificationResponse(notif.getNotifid(), notif.getChat().getId(), notif.getChat().getTaker().getUsername(), notif.getChat().getProduct().getId(), notif.getChat().getProduct().getProductName(), notif.getChat().getProduct().getImageUrl(), false);
