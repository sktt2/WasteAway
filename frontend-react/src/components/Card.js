        ...
        <CardHeader
          ...
          action={
            <IconButton aria-label="settings">
              ...
              >
                <MenuItem onClick={() => { history.push("/" + editDetailLink)}}>Edit Details</MenuItem>
                <MenuItem onClick={() => { handleClose(); triggerPopUp(id) } }>Delete</MenuItem>
              </Menu>
            </IconButton>
          }
          title={ownerName}
        ...
        <CardContent>
          ...
          {buttons === 4 && (
            <Box style={{ display: "flex", alignItems: "center",
              ...
              <Button style={{align:"left"}} variant="contained" href={buttonLink}>More Details</Button>
              <Button variant="contained" onClick={() => { triggerPopUp(id, "giveaway") } }>Giveaway</Button>
            </Box> 
          )}
          {buttons === 1 && (
            ...
            <Button variant="contained" style={{marginLeft: 'auto'}} href={buttonLink}>details</Button>
            </CardActions>
          )}
