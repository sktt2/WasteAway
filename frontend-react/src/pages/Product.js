    ...
    async componentDidMount() {
        ...
        if (StorageHelper.getUser()) {
            ...
            res.data.forEach((element) => {
                if (
                    element.category.toLowerCase() === recommend.data.toLowerCase() &&
                    element.ownerName !== StorageHelper.getUsername()
                ) {
                                ...
                                <CardComponent
                                    ...
                                    isOwner={
                                        StorageHelper.getUser()
                                            ? StorageHelper.getUsername() === data.ownerName
                                                ? true
                                                : false
                                            : false
                                    }
                                    userExist={
                                        StorageHelper.getUser() ? true : false
                                    }></CardComponent>
                            </Grid>
                        ))}
                    </Grid>
