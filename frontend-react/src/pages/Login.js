                ...
                <div className="card col-md-6 offset-md-3 offset-md-3">
                    <div className="card-body">
                        ...
                        <Form noValidate className={this.state.validated} onSubmit={this.validateInputs}>
                            ...
                            <div>
                                <Form.Group>
                                    ...
                                    <div className="input-group">
                                        <Form.Control type={this.state.showpassword} id="password-input" required value={this.state.password || ""}
                                            onChange={(event) => this.setState({ password: event.target.value, })} placeholder="Password"/>
                                        <div className="input-group-append">
                                            <Button className="btn bg-transparent btn-outline-secondary" type="button" onClick={this.showPasswordClicked}>
                            ...
                            <div>
                                <Form.Check id="flexCheckDefault" onChange={this.isRememberMeClicked} label={"Remember Me"}/>
                            </div>
                            <a href="/forgotpass" className="card-link">Forgot password?</a>
                            <br></br>
                            <Button className="btn btn-success" type="submit">Login</Button> {' '}
                            <Button className="btn btn-success" onClick={() => this.props.history.push("/register")}>Register</Button>
                        </Form>
                    </div>
                </div>
            </div>
